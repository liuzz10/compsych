...
class Show(Scene):
    ...
    ## P4
        ...
        self.wait()
        self.play(heapify_box.animate.move_to(1.3*DOWN), create.animate.move_to(4*LEFT+1.3*UP), delete.animate.move_to(1.7*LEFT+1.3*UP), extract.animate.move_to(1.2*RIGHT+1.3*UP), build_heap.animate.move_to(4*RIGHT+1.3*UP))
